...
if(isset($_POST['codigounidad']) && !empty($_POST['codigounidad'])){
		...
		$_SESSION['$id_lote1']=$_POST['inserlote'];		
		$_SESSION['$id_silo1']=$_POST['insersilo'];	
		$_SESSION['$id_servicio1']=$_POST['inserservicio'];
		$_SESSION['$id_transportista1']=$_POST['codigounidad'];
		$_SESSION['$peso_teorico1']=$_POST['pesoteorico'];
		$_SESSION['$peso_bruto1']=$_POST['pesobruto'];		
  	  
// INICIA EL GUARDADO DE INFORMACION 
				
	

  mysql_query("insert into tab_transportista(id_transportista, dpi_transportista, ape_transportista, nom_transportista, dir_transportista, tel_transportista, placa_vehiculo, color_vehiculo, cap_vehiculo, obs_vehiculo, id_cliente, id_empresa, id_usuario2, ocupado, fecha_usuario, hora_usuario, id_usuario_modifica, fecha_modifica, hora_modifica ) values('$id1', '$dpi1', '$ape1' , '$nom1', '$dir1', '$tel1', '$placa1', '$color1', '$cap1', '$obs1', '$id_cliente1', '$id_empresa1', '$id_usuario',0, '$fecha_entrada',  '$hora_entrada', '$id_usuario', '$fecha_entrada', '$hora_entrada')",$con);     
