...
//<img src="logo/logo.png" width="80" height="66" />
	...
	$pdf->Cell(40,5,'REPORTE DE SERVICIO DE BASCULA',0,0,'C');
	$pdf->Ln(6);
	$pdf->Cell(80);	
...
$suma_total=0;
$result=mysql_query("SELECT a.*, b.* FROM tab_salida as a, tab_cliente as b WHERE a.id_cliente=b.id_cliente and a.id_cliente='$seleccion1' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') group by a.id_lote");
