...
$sql_lote=("insert into tab_inventario(id_inventario, id_lote, capacidad_lote, movimiento_lote, peso_sin_humedad, id_empresa, peso_sin_humedad_maximo,num_ajuste) values ('$in', '$id_lote1', '$cant_producto1','$movimiento1', '$peso_sin_humedad1', '$id_empresa', '$peso_sin_humedad1','0')");
     ...
     <div class="col-md-13">
       ...
       <div class="col-md-6">
         ...
         <div class="row"> <!-- Inicia Row -->
              ...
              <div id="feedback2">
             <div class="input-group">
              <input type="text" class="form-control input-lg" id="espacio_disponible" name="espacio_disponible" placeholder="Espacio dispobible en el SILO"style="background:#FFF" readonly>
...
$result = mysql_query($sql, $con);
 ...
 echo"<div class='responsive'><table width='auto' style='table-layout:fixed' align='center' cellpadding='5' cellspacing='0' class='display' id='tblInstituciones' >";
		...
		<a onClick='enviar(\"".$row['id_lote']."\");' style='cursor:pointer' title='Modificar registro'><img src='../images/recovery.png' width='28px' height='28px'></a></td>
		</td>	   
