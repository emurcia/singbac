  ...
  <div class="col-md-13">
     ...
     <div class="row"><!--- INICIO ROW----->
           ...
           <br>
             <div class="row"><!--- INICIO ROW----->
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg" value="<?PHP echo $fecha;?>" id="fecha_salida" name="fecha_salida" autocomplete="off" readonly style="background:#FFF;">
                 </div>
              </div>
              <div class="col-md-6">
              <div class="form-group">
               <label for="moneda_servicio">HORA SALIDA</label>
               <input type="text" class="form-control input-lg"  value="<?PHP echo $hora;?>" id="hora_salida" name="hora_salida" autocomplete="off" readonly style="background:#FFF;">
                   </div>
              </div>
         ...
         <div class="form-group">
              ...
              <div class="input-group">
              <input type="text" class="form-control input-lg soloNUMEROS" id="peso_tara"  name="peso_tara"  placeholder="PESO TARA" autocomplete="off"  style="background:#FFF;"  value="<?PHP echo $peso_tara1; ?>" >
              <span class="input-group-addon">KILOGRAMOS</span>
                  </div>
                  </div>
          </div>
