...
<?PHP
	...
	if($bandera_act=="yes"){
		$nombre_act2=strtoupper($_POST['nom_agricultoract']);
		$ape_act2=strtoupper($_POST['ape_agricultoract']);
		$nucleo_act2=$_POST['nucleo_familiaract'];
		
		if(isset($_POST['spmaizact']) or $_POST['spmaizact'] == '1'){ $spmaizactg=1;}else{$spmaizactg=0;}
		if(isset($_POST['spfrijolact']) or $_POST['spfrijolact'] == '1'){ $spfrijolactg=1;}else{$spfrijolactg=0;}
		if(isset($_POST['spsorgoact']) or $_POST['spsorgoact'] == '1'){ $spsorgoactg=1;}else{$spsorgoactg=0;}
		if(isset($_POST['spcafeact']) or $_POST['spcafeact'] == '1'){ $spcafeactg=1;}else{$spcafeactg=0;}
		if(isset($_POST['ssmaizact']) or $_POST['ssmaizact'] == '1'){ $ssmaizactg=1;}else{$ssmaizactg=0;}
		if(isset($_POST['ssfrijolact']) or $_POST['ssfrijolact'] == '1'){ $ssfrijolactg=1;}else{$ssfrijolactg=0;}
		if(isset($_POST['sssorgoact']) or $_POST['sssorgoact'] == '1'){ $sssorgoactg=1;}else{$sssorgoactg=0;}
		if(isset($_POST['sscafeact']) or $_POST['sscafeact'] == '1'){ $sscafeactg=1;}else{$sscafeactg=0;}
		$area_cultivaact1=$_POST['area_cultivaact'];
		$propiedadact1=$_POST['propiedadact'];
		if(isset($_POST['inviernoact']) or $_POST['inviernoact'] == '1'){ $inviernoactg=1;}else{$inviernoactg=0;}
		if(isset($_POST['postreraact']) or $_POST['postreraact'] == '1'){ $postreraactg=1;}else{$postreraactg=0;}
		if(isset($_POST['apanteact']) or $_POST['apanteact'] == '1'){ $apanteactg=1;}else{$apanteactg=0;}
		$departamentoact1=$_POST['nom_deptoact'];
		$municipioact1=$_POST['nom_muniact'];
		$zonaact1=$_POST['zonaact'];
		
		$tel_act2=strtoupper($_POST['tel_agricultoract']);
		$dir_act2=strtoupper($_POST['direccionact']);
...
while($row5 = mysql_fetch_array( $select5 ))
{
   ...
   if(isset($cod2)){
		$sql= ("UPDATE tab_agricultor SET nom_agricultor='$nombre_act2', ape_agricultor='$ape_act2', nucleo_familiar='$nucleo_act2', spmaiz='$spmaizactg', spfrijol='$spfrijolactg', spsorgo='$spsorgoactg', spcafe='$spcafeactg', ssmaiz='$ssmaizactg', ssfrijol='$ssfrijolactg', sssorgo='$sssorgoactg', sscafe='$sscafeactg', area_cultiva='$area_cultivaact1', propiedad='$propiedadact1', invierno='$inviernoactg', postrera='$postreraactg', apante='$apanteactg', nom_depto='$departamentoact1', nom_municipio='$municipioact1', zona='$zonaact1', tel_agricultor='$tel_act2', direccion='$dir_act2', id_usuario_modifica='$usuario_actualiza', fecha_modifica='$fecha', hora_modifica='$hora' WHERE dui_agricultor='$cod2' and id_empresa='$id_empresa'");
		mysql_query($sql,$con);
	}
	if(mysql_error())
		  { 
...
// INICIA EL GUARDADO DE INFORMACION 
		...
		$nom_depto1=strtoupper($_POST['nom_depto']);
		$nom_muni1=strtoupper($_POST['nom_muni']);
		$spmaiz1=$_POST['spmaiz']; if($spmaiz1!=1){$spmaiz1=0;}
		$spfrijol1=$_POST['spfrijol']; if($spfrijol1!=1){$spfrijol1=0;}
		$spsorgo1=$_POST['spsorgo']; if($spsorgo1!=1){$spsorgo1=0;}
		$spcafe1=$_POST['spcafe']; if($spcafe1!=1){$spcafe1=0;}
		$ssmaiz1=$_POST['ssmaiz']; if($ssmaiz1!=1){$ssmaiz1=0;}
		$ssfrijol1=$_POST['ssfrijol']; if($ssfrijol1!=1){$ssfrijol1=0;}
		$sssorgo1=$_POST['sssorgo']; if($sssorgo1!=1){$sssorgo1=0;}
		$sscafe1=$_POST['sscafe']; if($sscafe1!=1){$sscafe1=0;}
		 $nucleo1=$_POST["nucleo_familiar"];
		 $invierno1=$_POST['invierno']; if($invierno1!=1){$invierno1=0;}
		$postrera1=$_POST['postrera']; if($postrera1!=1){$postrera1=0;}
		$apante1=$_POST['apante']; if($apante1!=1){$apante1=0;}
...
mysql_query("insert into tab_agricultor(zona, dui_agricultor, nom_agricultor, ape_agricultor, propiedad, area_cultiva, oficio, epoca_siembra, tel_agricultor, direccion, id_usuario_ingreso, fecha_ingreso, hora_ingreso, id_usuario_modifica, fecha_modifica, hora_modifica, id_empresa, eliminado, ninos, adultos, terceraedad, canasta, nom_depto, nom_municipio, spmaiz, spfrijol, spsorgo, spcafe, ssmaiz, ssfrijol, sssorgo, sscafe, nucleo_familiar, invierno, postrera, apante) values ('$zona1', '$dui_agricultor1', '$nom_agricultor1', '$ape_agricultor1', '$propiedad1', '$area_cultiva1', '$oficio1', '$epoca_siembra1', '$tel_agricultor1', '$direccion1', '$id_usuario', '$fecha', '$hora','$id_usuario','$fecha','$hora','$id_empresa','0','$nin1','$adul1','$adulmayor1','$viveres2', '$nom_depto1', '$nom_muni1', '$spmaiz1', '$spfrijol1', '$spsorgo1', '$spcafe1', '$ssmaiz1', '$ssfrijol1', '$sssorgo1', '$sscafe1', '$nucleo1', '$invierno1', '$postrera1', '$apante1')",$con);     
        ...
        <input name="bandera" value="0" type="hidden" />     
           ...
           <input type="hidden" name="dui_prod_modif">          
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg soloLetras" id="ape_agricultor"  name="ape_agricultor" placeholder="APELLIDO" style="text-transform:uppercase" autocomplete="off" required/>    
                  </div>
              </div>
           </div><!--- FIN ROW----->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg soloNumeros" style="text-transform:uppercase" id="nucleo_familiar" name="nucleo_familiar" placeholder="NUCLEO FAMILIAR" autocomplete="off" required/>           
                  </div>
              </div>
              </div><!--- FIN ROW----->
              ...
              <div class="form-group">
               ...
               <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="spmaiz" value="1"> Maíz
    	  </label></div></span>
              <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="spfrijol" value="1"> Frijol
    	  </label></div></span>  
          <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="spsorgo" value="1"> Sorgo
    	  </label></div></span>
              <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="spcafe" value="1"> Café
    	  </label></div></span> 
                  </div>
              </div>
           </div><!--- FIN ROW----->
             <div class="row"><!--- INICIO ROW----->
              ...
              <div class="form-group">
               ...
               <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="ssmaiz" value="1"> Maíz
    	  </label></div></span>
              <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="ssfrijol" value="1"> Frijol
    	  </label></div></span>  
          <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="sssorgo" value="1"> Sorgo
    	  </label></div></span>
              <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="sscafe" value="1"> Café
    	  </label></div></span> 
                  </div>
              </div>
           </div><!--- FIN ROW----->
              ...
              <div class="form-group">
               <label>EPOCA DE SIEMBRA:</label>
                <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="invierno" value="1"> Invierno
    	  </label></div></span>
              <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="postrera" value="1"> Postrera
    	  </label></div></span>  
          <span class="input-group-addon"><div class="input-group"><label><input type="checkbox" name="apante" value="1"> Apante
    	  </label></div></span>
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg soloLetras" style="text-transform:uppercase" id="nom_depto" name="nom_depto" value="SAN VICENTE" autocomplete="off" />           
                  </div>
              </div>
            ...
            <div class="row"><!--- INICIO ROW----->
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg soloLetras" id="nom_muni"  name="nom_muni" value="SAN CAYETANO ISTEPEQUE" style="text-transform:uppercase" autocomplete="off"/>    
                  </div>
              </div>
