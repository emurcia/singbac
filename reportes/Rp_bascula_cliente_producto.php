...
$hora=date("H:i:s");
	...
	$this->Cell(40,5,'REPORTE DE SERVICIO DE BASCULA',0,0,'C');
	$this->Ln(6);
	$this->Cell(80);	
...
$transacciones=0;
if($cod_producto2=="0"){
	$result=mysql_query("SELECT a.*, b.* FROM tab_bascula as a, tab_cliente as b WHERE a.id_cliente=b.id_cliente and a.id_cliente='$seleccion1' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') group by a.id_subproducto");
	}else{
...
$reporte=mysql_query("SELECT a.*, b.* FROM tab_bascula as a, tab_cliente as b WHERE a.id_cliente=b.id_cliente and a.id_cliente='$seleccion1' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and id_subproducto='$id_subproducto1' and a.id_producto='$id_producto1'");	
