...
mysql_query("insert into t_usuarios(id_usuario, nombre_usuario, correo_usuario, pass_usuario, activo_usuario, id_nivel, id_empresa, id_usuario2, ocupado, fecha_usuario, hora_usuario, id_usuario_modifica, fecha_modifica, hora_modifica, token) values ('$id_nuevo1', '$nombre1', '$correo1', '$pass1', '$activo_usuario1', '$nivel1', '$id_empresa', '$id_usuario',0, '$fecha', '$hora','$id_usuario','$fecha','$hora','$token1')",$con);     
