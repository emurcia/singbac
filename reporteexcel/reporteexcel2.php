...
include ("conexion/conexion.inc");
	...
	if ($result > 0){	
		...
		$titulosColumnas = array('NOMBRE', 'FECHA DE NACIMIENTO', 'SEXO', 'CARRERA', 'OTROS');
		...
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i,  $row['id_nivel'])
		->setCellValue('B'.$i,  $row['id_nivel'])
		->setCellValue('C'.$i,  $row['id_nivel'])
		->setCellValue('D'.$i,  $row['id_nivel'])						
		->setCellValue('E'.$i,  $row['id_nivel']);
		$i++;
							}
