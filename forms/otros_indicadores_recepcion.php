...
$id_agencia_recibe = mysql_real_escape_string($_POST['id_cuentas_buscarecepcion']);
        ...
        <div class="panel panel-primary">
         ...
         <div class="col-md-8">
          <div class="checkbox">
            ...
            <div class="col-md-2"> 
<button type="button" disabled id="btnguardar_actrecepcion"  name="btnguardar_actrecepcion" class="btn btn-primary glyphicon glyphicon-saved center pull-right" data-toggle="modal" data-target="#actualizarrecepcion" value="Guardar">  Guardar</button>
 </div> 
            <div class="col-md-2"> 
