...
// INICIA EL GUARDADO DE INFORMACION 
		 ...
		 $tipo_cliente1 = $_POST['tipo_cliente'];	
...
if($cliente_utilizado2['existe']!="0"){ // no ha sido utilizado
	$error="5"; // Cliente ya existe
			...
			mysql_query("insert into tab_cliente(id_cliente, nom_cliente, dir_cliente, tel_cliente, ape_responsable, nom_responsable, dir_responsable, tel_responsable, id_empresa, id_usuario2, ocupado, fecha_usuario, hora_usuario, id_usuario_modifica, fecha_modifica, hora_modifica, tipo_cliente, otros_indicadores) values('$id_nuevo', '$nombre', '$direccion' , '$tel', '$ape1', '$nom1', '$dir1', '$tel1', '$id_empresa', '$id_usuario',0, '$fecha', '$hora','$id_usuario','$fecha','$hora', '$tipo_cliente1','$activar_indig')",$con);     
			
			mysql_query("insert into tab_detalle_cliente(id_cliente_principal, id_cliente_secundario, id_empresa) values('$id_nuevo', '$id_nuevo', '$id_empresa')",$con);     
  ...
  <div class="row" >
     <div class="col-md-13">
        <div class="panel panel-primary">
           ...
           <input type="hidden" name="activar_indi"> 
          ...
          <div class="form-group">
             ...
             <input type="text" class="form-control input-lg soloNUMEROS" id="tel_cliente" onkeypress="mascara(this, '####-####')" maxlength="9" placeholder="Telefono del cliente"  name="tel_cliente" autocomplete="off" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label for="nacional">Clasificación del cliente</label><br>
                          
                          <label class="checkbox-inline">
                            <input type="radio" id="tipo_cliente" value="1" name="tipo_cliente"  checked autofocus>  Principal
                          </label>
                          <label class="checkbox-inline">
                          
                            <input type="radio" id="tipo_cliente" value="2" name="tipo_cliente">  Secundaria 
                          </label>
