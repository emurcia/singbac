...
{//inicio entrar
 ...
 alertify.alert("<b> <?PHP echo $nom_sistema; ?>  </b>  Estimado usuario, el sistema se actualizará muy pronto. Clic en aceptar y continuar con el inicio de sesión", function () {
					});
}//fin entrar
</script>
...
<body onload="mensajeerror()"; <?php if($_GET['action']=="expired")  echo '<div>Estimado Usuario, le informamos que se abrió otra sesión con sus credenciales.!!!</div>';?> >
...
if ($error == 5)
 {
	echo "<br><br> <div class='alert alert-danger alert-dismissable'>
			  <button type='button' class='close' data-dismiss='alert'>&times;</button>
			  <center><strong>¡Error!</strong> Estimado Usuario, le informamos que se abrió otra sesión con sus credenciales.!!!</center>
			</div>";
...
?>
		...
		<form action="index.php" method="post" name="formulario" role="form">  
  ...
  <div id="formContent">
		...
		<div class="fadeIn first">
			...
			<h1 style="color:#000"><center><img src="images/favicon.png">   Iniciar sesión   <img  width="40px" src="images/user.png"></center></h1>
					 
		</div>             
			  <div style="padding-left:4%; padding-right:4%">
               <label style="color:#000">USUARIO:</label>
			  <input type="text" class="form-control input-lg fadeIn second" id="correo_usuario" name="correo_usuario" placeholder="Correo Electrónico" required autofocus="" autocomplete="off" />
              </div>
              <br />
              <div style="padding-left:4%; padding-right:4%">
              <label style="color:#000">CONTRASEÑA:</label>
               <input type="password" class="form-control input-lg fadeIn third" name="pass_usuario" id="pass_usuario" placeholder="Contraseña" autofocus="" autocomplete="off" required/>     		  			 
               </div>
              <br />
 
          <br />	
			 <div align="center">
			  <input  name="submit" class="fadeIn fourth" value="Entrar" type="submit" onclick="entrar();" />
