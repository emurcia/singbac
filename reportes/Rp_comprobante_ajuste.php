...
while($row_extrae = mysql_fetch_array($select_extrae))
{
			 ...
			 $hora_almacenado=$row_extrae['hora_usuario_ajuste'];
			 $usuario_autoriza=$row_extrae['id_usuario_autoriza'];
			 $usuario_elabora=$row_extrae['id_usuario2_ajuste'];
			 $entrada=$row_extrae['entrada'];			 
...
$loginSQL=mysql_query("select nombre_usuario from t_usuarios  where id_usuario='$usuario_elabora'",$con);
...
$hora=date("H:i:s");
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(22);
 	$pdf->cell(80,5,($nom_silo));
	$pdf->Cell(-25);
    $pdf->Cell(10,5,utf8_decode('N° de Lote:'),0,0,'J',0); 
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(22);
 	$pdf->cell(80,5,($num_lote));
	$pdf->Ln(5);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(17);
    $pdf->Cell(10,5,('Fecha Procesado:'),0,0,'J',0); 
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(22);
 	$pdf->cell(80,5,$fecha_imprime_ajuste);
	$pdf->Cell(-25);
    $pdf->Cell(10,5,utf8_decode('Hora Procesado:'),0,0,'J',0); 
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(22);
 	$pdf->cell(80,5,$hora_almacenado);
	$pdf->Ln(8);	
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(35);
 	$pdf->Cell(10,5,$peso_bruto_entrada,0,'R',0);
	$pdf->Cell(31);
 	$pdf->Cell(5,5,$peso_tara_entrada,0,'R',0);
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_saldo_entrada,0,'R',0);	
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_humedad_entrada,0,'R',0);	
	$pdf->Cell(15);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(35);
 	$pdf->Cell(10,5,$peso_bruto_salida,0,'R',0);
	$pdf->Cell(31);
 	$pdf->Cell(5,5,$peso_tara_salida,0,'R',0);
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_saldo_salida,0,'R',0);	
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_humedad_salida,0,'R',0);	
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(35);
 	$pdf->Cell(10,5,$peso_bruto_saldo,0,'R',0);
	$pdf->Cell(31);
 	$pdf->Cell(5,5,$peso_tara_saldo,0,'R',0);
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_neto_saldo,0,'R',0);	
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_humedad_saldo,0,'R',0);	
	$pdf->Ln(5);
	$pdf->Cell(10);
	$pdf->SetFont('Arial','B',11);	
    $pdf->Cell(10,5,'Ajuste' ,0,0,'J',0); 
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(35);
 	$pdf->Cell(10,5,$peso_bruto_ajuste,0,'R',0);
	$pdf->Cell(31);
 	$pdf->Cell(5,5,$peso_tara_ajuste,0,'R',0);
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_neto_ajuste,0,'R',0);	
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_humedad_ajuste,0,'R',0);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(35);
 	$pdf->Cell(10,5,$peso_bruto_nuevo,0,'R',0);
	$pdf->Cell(31);
 	$pdf->Cell(5,5,$peso_tara_nuevo,0,'R',0);
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_neto_nuevo,0,'R',0);	
	$pdf->Cell(25);
 	$pdf->Cell(5,5,$peso_humedad_nuevo,0,'R',0);
