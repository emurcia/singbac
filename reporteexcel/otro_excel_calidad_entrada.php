...
if($cod_usuario_cliente!=''){
	...
	if($id_cliente2=="0" AND $id_lote2=="0"){
$where1 = "a.id_almacenaje=rec.id_almacenaje AND a.id_cliente=b.id_cliente  and a.id_lote=c.id_lote and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' group by a.entrada";
}else{
	if($id_cliente2!="0" AND $id_lote2=="0"){
	$where1 = "a.id_almacenaje=rec.id_almacenaje AND a.id_cliente=b.id_cliente and a.id_lote=c.id_lote and a.id_cliente='$id_cliente2' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' group by a.entrada ";
	}else{
		$where1 = "a.id_almacenaje=rec.id_almacenaje AND a.id_cliente=b.id_cliente and a.id_lote=c.id_lote and a.id_cliente='$id_cliente2' and a.id_lote='$id_lote2' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' group by a.entrada";
	      }
}
		} 
...
$sql=("SELECT a.*, b.*, c.*, rec.* FROM tab_almacenaje as a, tab_cliente as b, tab_lote as c, tab_indicadoresrecepcion as rec WHERE $where1"); //
}else{
