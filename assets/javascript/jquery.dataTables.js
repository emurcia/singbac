	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input class="txtData" type="text" />') :
			  sSearchStr==="" ? '<input type="text" class="txtData" />' : sSearchStr+' <input class="txtData" type="text" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="selectData" size="1" '+sName+'>';
			var i, iLen;
