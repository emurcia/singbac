...
include("../function/functions.inc");
  ...
  $id_lote2 = mysql_real_escape_string($_POST['id_cliente_busca']);
  if(($id_lote2 !="" ))//entra cuando ocurre el change de municipio
  {
     $consulta=mysql_query("SELECT * FROM tab_transportista WHERE id_cliente = '".$id_lote2."'",$con);
     echo " <select name='id_transportista' id='id_transportista' class='chosen' style='width:100%; border: 1px solid #ddd; height: 46px; border-color: #66afe9; outline: 0;  -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(102, 175, 233, .6);     box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(102, 175, 233, .6); border-radius: 4px;' >";
     echo "<option value='TRANS-000'> SELECCIONE TRANSPORTISTA</option>";
