  ...
  <div class="col-md-13">
        <div class="panel panel-primary">
           ...
           <div class="panel-body" >
          		...
          		<form action="f_rep_saldo.php" class="formusu" method="post" name="formulario" role="form">  
