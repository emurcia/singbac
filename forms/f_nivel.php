  		...
  		<strong>¡Adventencia!</strong> Ingrese nombre del Nivel
			...
			if(mysql_error())
				  { 
					...
					mysql_query("insert into tab_detalle_menu(id_nivel, id_menu, id_empresa) values ('$id_nuevo', '1', '$id_empresa'), ('$id_nuevo', '110', '$id_empresa'),('$id_nuevo', '111', '$id_empresa');",$con); 
  ...
  <div class="row" >
    ...
    <div class="col-md-13">
        <div class="panel panel-primary">
           <div class="panel-heading"><strong>Registro de Niveles de Usuarios</strong></div> <!-- PANEL 1 --->
          ...
          <div class="form-group">
            	...
            	<input type="text" class="form-control input-lg" value="<?PHP echo $nu; ?>"   name="id_nivel" id="id_nivel" autocomplete="off" style="background:#FFF" readonly>
            </div>
          </div>
          ...
          <div class="col-md-12">
          <div class="form-group">
          		<label for="nombre_producto">Nombre del Nivel</label>
            	<input type="text" class="form-control input-lg" id="nom_nivel" style="text-transform:uppercase;" placeholder="Nombre del Nivel"  name="nom_nivel" value="<?PHP echo $nombre; ?>" autocomplete="off" required>	
            </div>
          </div>
           </div><!--- FIN ROW-----> 
