...
function salirr()
 {	 
  ...
  function reporte(){
	 window.open('../reportes/Rp_bascula.php?id='+document.formulario.reporte.value+'&id2='+document.formulario.fec1.value+'&id3='+document.formulario.fec2.value,target="_blank",'directories=no,status=yes, titlebar=no, Width=800; Height:600, scrollbars=yes, resizeable=no, directories=no, toolbar=no menubar=no, top=50,left=200');
}
</script>
  ...
  <div class="col-md-13">
        <div class="panel panel-primary">
           ...
           <div class="panel-body" >
            <form action="f_rep_bascula_producto.php" method="post" name="formulario" role="form" >  
