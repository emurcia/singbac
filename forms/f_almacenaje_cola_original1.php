...
$id_almacen="ALMACEN-0000000".$id_empresa;
	 ...
	 echo"<div class='table'><table width='auto' style='table-layout:fixed' align='center' cellpadding='5' cellspacing='0' class=' display' id='tblInstituciones' >";
		...
		echo"<tr>
		<td width='60px' align='center'><a data-toggle='modal' data-target='#ventana4' onClick='eliminar(\"".$row['id_almacenaje']."\");' style='cursor:pointer' title='Eliminar registro'><img src='../images/trash-icon.png' width='28px' height='28px'></a>
		<a onClick='tara(\"".$row['id_almacenaje']."\");' style='cursor:pointer' title='Completar Peso'><img src='../images/aceptar.png' width='28px' height='28px'></a></td>	   
