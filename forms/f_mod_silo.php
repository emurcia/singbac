...
$tabla="SELECT *  FROM tab_silo where id_silo='$_POST[codigo_modificar]' and id_empresa='$id_empresa' and bandera=0";
...
function cancelar(){
		document.location.href='f_silo.php';	
	}
function salirr()
 {	 
...
$resultado = autorizar_mod($nombre_usuario,$con_usuario,$activo,$empresa,$modificar);	
	...
	$tabla="SELECT *  FROM tab_silo where id_silo='".$_SESSION['codigo']."' and id_empresa='$id_empresa'";
	...
	$usuario_actualiza=$row5['id_usuario'];
	 ...
	 if($nombre1==""){
		 echo '<div class="alert alert-warning alert-dismissable">
  		...
  		<strong>¡Adventencia!</strong> Ingrese SILO
		</div>';
		 }else {
      if(isset($cod)){
		$sql= ("UPDATE `tab_silo` SET `nom_silo`='$nombre1',`desc_silo`='$desc1',`dir_silo`='$dir1',`cap_silo`='$cap1', id_usuario_modifica='$usuario_actualiza', fecha_modifica='$fecha', hora_modifica='$hora' WHERE id_silo='$cod'");
mysql_query($sql,$con);
		  }
if(mysql_error())
		  { 
...
<?PHP 
 ...
 if($error == "2")
 {
	 ...
	 echo '<div class="alert alert-success">
 						  <a href="f_silo.php" class="alert-link">Datos Actualizados con éxito!!! Haga click para continuar .....</a>
						  </div>';
	  }
...
if($error == "3")
 {
	 echo '<div class="alert alert-danger">
 						  <a href="f_silo.php" class="alert-link">No tiene permiso para modificar registro!!! Haga click para continuar .....</a>
						  </div>';
	  }	  
 ?>
    ...
    <div class="col-md-13">
        <div class="panel panel-primary">
           ...
           <div class="panel-body" >
           	<form role="form" name="formulario"  method="post" action="f_mod_silo.php">
           ...
           <div class="row"><!--- INICIO ROW----->
                         <div class="col-md-12">
                          <div class="form-group">
                                <label>Código</label>
                                <input type="text" class="form-control input-lg" value="<?PHP echo $cod; ?>"   name="id_silo" id="id_silo" autocomplete="off">
                            </div>
                          </div>
                                           ...
                                           <div class="row"><!--- INICIO ROW----->
                                            <div class="col-md-12">
                              <div class="form-group">
                                    <label for="origen_producto">SILO</label><input type="text" class="form-control input-lg" style="text-transform:uppercase;" id="nom_silo" placeholder="Unidad de Peso" value="<?PHP echo $nom; ?>"  name="nom_silo" required autocomplete="off">
                              </div>
                            </div>
                          </div><!--- FIN ROW-----> 
             ...
             <div class="row"><!--- INICIO ROW----->
                            <div class="col-md-12">
                              ...
                              <label>Capacidad del SILO</label>
                                ...
                                <input type="text" class="form-control input-lg soloNUMEROS" value="<?PHP echo $cap; ?>"   name="cap_silo" id="cap_silo" autocomplete="off"  placeholder="CAPACIDAD DEL SILO"required>
                     ...
                     <div class="row"><!--- INICIO ROW----->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_silo" class="form-control input-lg" style="text-transform:uppercase;" rows="3" placeholder="Descripción" autocomplete="off" id="desc_silo" required><?PHP echo $desc; ?></textarea>
                                    </div>
                                </div>
                            </div><!--- FIN ROW----->
                             <div class="row"><!--- INICIO ROW----->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="dir_silo" class="form-control input-lg" style="text-transform:uppercase;" rows="3" placeholder="Dirección" autocomplete="off" id="dir_silo" required><?PHP echo $dir; ?></textarea>
                                    </div>
                                </div>
                            </div><!--- FIN ROW----->
