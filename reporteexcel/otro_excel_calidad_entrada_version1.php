...
if($cod_usuario_cliente!=''){
		...
		$where = "a.id_cliente=b.id_cliente AND b.id_cliente=decl.id_cliente_secundario AND a.id_almacenaje=rec.id_almacenaje AND decl.id_cliente_principal='$cod_usuario_cliente' and a.id_lote=c.id_lote and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' ";
			...
			if($id_cliente2!="0" AND $id_lote2=="0"){
			$where = "a.id_cliente=b.id_cliente AND b.id_cliente=decl.id_cliente_secundario AND a.id_almacenaje=rec.id_almacenaje and a.id_lote=c.id_lote and a.id_cliente='$id_cliente2' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' ";
			}else{
	...
	if($id_cliente2=="0" AND $id_lote2=="0"){
$where1 = "a.id_cliente=b.id_cliente  and a.id_lote=c.id_lote and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' ";
}else{
	if($id_cliente2!="0" AND $id_lote2=="0"){
	$where1 = "a.id_cliente=b.id_cliente and a.id_lote=c.id_lote and a.id_cliente='$id_cliente2' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa' ";
	}else{
		$where1 = "a.id_cliente=b.id_cliente and a.id_lote=c.id_lote and a.id_cliente='$id_cliente2' and a.id_lote='$id_lote2' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.peso_bruto!='0'  and a.bandera='2' AND a.id_empresa='$id_empresa'";
	      }
}
		} 
...
$sql=("SELECT a.*, b.*, c.* FROM tab_almacenaje as a, tab_cliente as b, tab_lote as c WHERE $where1"); //
}else{
$sql=("SELECT a.*, b.*, c.*, rec.* FROM tab_almacenaje as a, tab_cliente as b, tab_lote as c,  tab_detalle_cliente as decl, tab_indicadoresrecepcion as rec WHERE $where"); //
  }
...
//		date_default_timezone_set('America/Mexico_City');
		...
		$objWorkSheet->setTitle("$i");
		 $i++; } 
		*/
		$tituloReporte = "REPORTE DE CALIDAD -  ENTRADA";
