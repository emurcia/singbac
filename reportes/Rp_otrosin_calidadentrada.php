...
$result=mysql_query("SELECT a.id_cliente, a.id_lote, a.entrada, a.id_transportista, a.id_silo, a.peso_bruto, a.peso_tara, a.neto_sin_humedad, a.fecha_entrada, a.hora_entrada, a.fecha_salida, a.hora_salida, b.* FROM tab_almacenaje as a, tab_indicadoresrecepcion as b WHERE a.id_almacenaje=b.id_almacenaje AND a.id_almacenaje='$id_despacho_buscar'");
...
class PDF extends FPDF
{
  //Cabecera de página
	...
	$this->Ln(4);	 
	$this->Cell(70);
	$this->Cell(5,5,utf8_decode(' FORMATO DE REGISTRO: RECEPCIÓN'),0,0,'J');
	$this->Ln(-2);
	$this->Cell(145);
    $this->SetFont('Arial','',9);
