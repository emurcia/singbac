...
function ver(){
	  $.post('consultar_calidad_salida.php', {id_cliente_busca:document.formulario.id_cliente.value, id_lote_busca:document.formulario.id_lote2.value, fecha_inicio11:document.formulario.fec_inicio.value, fecha_fin11:document.formulario.fec_fin.value}, 
			 function(result) {
            ...
            <input type="hidden"  name="fec2" value="<?PHP echo $_POST['fec_fin']; ?>">            
             <div class="row"><!--- INICIO ROW----->
			  ...
			  if($cod_usuario_cliente==""){
                ...
                $tabla=mysql_query("SELECT a.id_cliente, a.nom_cliente, b.id_salida FROM tab_cliente as a, tab_salida as b WHERE a.id_cliente=b.id_cliente AND b.id_cliente!='$cli' GROUP by b.id_cliente",$con); //
			  }else{
