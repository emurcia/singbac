...
$peso_seco_actual=$fila_usu['neto_sin_humedad'];
$_SESSION['peso_bruto1']=$fila_usu['peso_bruto'];
$_SESSION['peso_tara1']=$fila_usu['peso_tara'];

$nuevo_peso= ($fila_usu['peso_bruto']- $fila_usu['peso_tara']); 	
...
?>
 ...
 <script>
	...
	document.formulario.humedad_calcu.value=((document.indicador.humedadg.value-14)/100);
	document.formulario.peso_bruto_tara.value=<?PHP echo $nuevo_peso; ?>;
	document.formulario.nuevo_calculo.value=(document.formulario.peso_bruto_tara.value-(document.formulario.peso_bruto_tara.value*document.formulario.humedad_calcu.value*1.17));
	
	document.indicador.nuevo_peso_seco.value=document.formulario.nuevo_calculo.value;

	
	//alert(document.formulario.temperatura_calcu.value);
	//alert(document.formulario.peso_bruto_tara.value);
	//alert(document.formulario.nuevo_calculo.value);
	}
  ...
  <div class="col-md-13">
        <div class="panel panel-primary">
         ...
         <div class="form-group">
              <label>HUMEDAD</label>
              <div class="input-group">
              <input type="text" class="form-control input-lg soloNUMEROS" id="humedadg"  name="humedadg" value="<?PHP echo $humedad;?>" autocomplete="off" onkeypress="mascara(this, '##.##')"  onkeyup="nuevo_peso()" maxlength="5" >
       ...
       <br>
        ...
        <div class="row"><!--- INICIO ROW----->
         <div class="col-md-6">
         <div class="form-group">
              <label>PESO SECO ACTUAL</label>
              <input type="text" class="form-control input-lg" id="peso_seco_actual"  name="peso_seco_actual" value="<?PHP echo $peso_seco_actual;?>" style="background:#FFF;"  readonly="readonly" >
            ...
            <div class="col-md-6">
         <div class="form-group">
              <label>PESO SECO NUEVO</label>
              <input type="text" class="form-control input-lg" id="nuevo_peso_seco"  name="nuevo_peso_seco"  autocomplete="off" readonly="readonly" style="background:#FFF;" >
