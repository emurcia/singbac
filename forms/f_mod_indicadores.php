...
// leer variables
   ...
   $olorg1=$_POST['olorg'];    		  
   $vaporg1=$_POST['vaporg']; 
   $nuevo_peso_secog1=$_POST['nuevo_peso_seco']; 
  	  
  // $peso_bruto_cal=$_SESSION['peso_bruto1'];
  // $peso_tara_cal=$_SESSION['peso_tara1'];
...
while($row5 = mysql_fetch_array( $select5 ))
{
   ...
   if(isset($entrada)){
		$sql= ("UPDATE tab_almacenaje SET peso_vol='$peso_volg1', humedad='$humedadg1', temperatura='$temperaturag1', grano_entero='$grano_enterog1', grano_quebrado='$grano_quebradog1', dan_hongo='$dan_hongog1', impureza='$impurezag1', grano_chico='$grano_chicog1', grano_picado='$grano_picadog1', plaga_viva='$plaga_vivag1', plaga_muerta='$plaga_muertag1', stress_crack='$stress_crackg1', olor='$olorg1', vapor='$vaporg1', neto_sin_humedad='$nuevo_peso_secog1', id_usuario_mod_indicador='$usuario_actualiza', fec_mod_indicador='$fec_entrada2', hor_mod_indicador='$hora_entrada'  WHERE entrada='$entrada' and id_empresa='$id_empresa'")  or die(mysql_error());
		mysql_query($sql,$con);
	}
	if(mysql_error())
		  { 
...
<input type="hidden" name="peso_bruto_tara" value="">
<input type="hidden" name="humedad_calcu" value="">
<input type="hidden" name="nuevo_calculo" value="">
</form>         	
