  ...
  <div class="col-md-13">
           ...
           <input type="hidden"  name="reporte" value="<?PHP echo $nu; ?>">             
            ...
            <input type="hidden" name="cod_prod_modif">                       
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg" value="<?PHP echo $entrada;?>" id="entrada1"  name="entrada1" autocomplete="off" style="background:#FFF;" >
     ...
     <div class="row"><!--- INICIO ROW----->
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg" value="<?PHP echo $fecha;?>" id="fecha_entrada" name="fecha_entrada" autocomplete="off" style="background:#FFF;">
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control input-lg" value="<?PHP echo $hora;?>" id="hora_entrada" name="hora_entrada" autocomplete="off" style="background:#FFF;">
