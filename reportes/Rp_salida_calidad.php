...
$bascula=mysql_query("SELECT * FROM tab_cliente WHERE id_cliente='$seleccion1' and id_empresa='$id_empresa'");
...
$suma_total=0;
$transacciones=0;
$result=mysql_query("SELECT a.*, b.* FROM tab_salida as a, tab_cliente as b WHERE a.id_cliente=b.id_cliente and a.id_cliente='$seleccion1' and a.peso_bruto!=0 and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada <= '$fecha_fin_buscar') and a.id_empresa='$id_empresa' group by a.id_lote ");
...
$reporte=mysql_query("SELECT a.*, b.*, c.* FROM tab_salida as a, tab_cliente as b, tab_lote as c WHERE a.id_cliente=b.id_cliente and a.id_cliente=c.id_cliente and a.id_cliente='$seleccion1' and (a.fecha_entrada>= '$fecha_inicio_buscar' and a.fecha_entrada<= '$fecha_fin_buscar') and c.id_subproducto='$id_subproducto1' and c.id_producto='$id_producto1' and a.id_lote='$id_lote2' and a.bandera='2' and a.id_empresa='$id_empresa' and a.peso_bruto!=0 group by c.id_subproducto, c.id_producto, a.entrada, a.id_lote",$con);	
	 while($row_datos2 = mysql_fetch_array($reporte)){
		...
		$olor1=$row_datos2['olor'];
		$vapor1=$row_datos2['vapor'];
		$neto_sin_humedad1=$peso_neto1; // todo lo que se saca es sin humedad
...
$variable=mysql_query("SELECT * FROM tab_variables WHERE id_variable='$id_variable' and id_empresa='$id_empresa'");
	...
	$pdf->Cell(10);
    $pdf->Cell(5,5,round($neto_sin_humedad1,2));			
 	$pdf->Ln(5);
   }
   	$pdf->Cell(38);
	...
	$pdf->Cell(16);	
	$pdf->Cell(5,5,round($suma_subtotal,2));
	$pdf->Cell(201);	
	$pdf->Cell(5,5,round($suma_sin_humedad,2));
	...
	$pdf->Cell(16);	
	$pdf->Cell(5,5,round($suma_total),2);
	$pdf->Cell(27);
	$pdf->SetFont('Arial','B',10);	
	...
	$pdf->Cell(139);	
	$pdf->Cell(5,5,round($suma_sin_humedad_total,2));
	$pdf->Ln(5);
	$pdf->Cell(38);
	$pdf->Cell(20, 0, '', 1, 1, 0, 'J', false );
	$pdf->Ln(1);
