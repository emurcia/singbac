...
// INICIA EL GUARDADO DE INFORMACION 
		echo $bandera = $_POST['bandera'];
		 $codigo1="1";
		echo $cod_nue_ser=$nu; // codigo interno de la bascula
		...
		echo $fecha_entrada1=parseDateMysql($_POST['fecha_entrada']);
		$hora_entrada1=$_POST['hora_entrada'];
		echo $fecha_salida1=parseDateMysql($_POST['fecha_entrada']);
