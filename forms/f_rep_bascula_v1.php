            ...
            <input type="hidden"  name="fec2" value="<?PHP echo $_POST['fec_fin']; ?>">            
             <div class="row"><!--- INICIO ROW----->
              ...
              <?php
                	...
                	$tabla=mysql_query("SELECT b.id_cliente as id_cliente, c.nom_cliente as nom_cliente FROM tab_bascula as b JOIN tab_cliente as c ON b.id_cliente=c.id_cliente WHERE b.id_cliente!='$cli' and b.id_empresa='$id_empresa' GROUP BY b.id_cliente ",$con); //
				?>
