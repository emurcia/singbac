...
while($row = mysql_fetch_array($result)){
	...
	$peso_neto1=$row['peso_bruto']-$row['peso_tara'];
	...
	if($row['opcion_peso']==3) $peso_imprime="PESAJE UNICO";
	if($row['opcion_peso']==4) $peso_imprime="PESAJE COMPLETO";
...
//	$pdf->Cell(22);
 ...
 //	$pdf->MultiCell(80,5,utf8_decode($_SESSION['nombre_usuario_silo']));
	...
	$pdf->SetFont('Arial','B',10);	
	$pdf->Cell(10);
	$pdf->Cell(25,5,$peso_imprime,0,'C');	
